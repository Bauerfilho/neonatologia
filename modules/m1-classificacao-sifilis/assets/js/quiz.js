// Quiz universal — persistência localStorage namespace neonato-p1-m1
// Suporta: MCQ (botões com data-correct), V-F, Lacuna (input + reveal)
// Acessibilidade: ARIA radiogroup, navegação por setas, feedback aria-live

(function () {
  'use strict';

  const NS = 'neonato-p1-m1.quiz.';
  ...
  function initQuiz(quizEl) {
    ...
    questions.forEach((q, i) => bindMCQ(q, quizId, i, state));
  }

// Quiz universal — persistência localStorage namespace neonato-p2-m11
...
(function () {
  ...
  function bindGap(question, quizId, qIndex, state) {
    ...
    const revealBtn = question.querySelector('.quiz__gap-reveal');
    if (!input || !revealBtn) return;
    if (state[qIndex] != null) {

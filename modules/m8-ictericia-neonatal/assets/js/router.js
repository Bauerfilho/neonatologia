// Hash router SPA. Namespace #/p2-m8-p{1..15}
// Icterícia neonatal — M8 (Parte 2, Aula principal 3 de 3)
// Mantém histórico do navegador, fecha drawer, atualiza progresso e ARIA.

(function () {
  'use strict';

  const PAGES_TOTAL = 15;
  const HASH_PREFIX = '#/p2-m8-p';
  const STORAGE_PREFIX = 'neonato-p2-m8';
  ...
  function updateTitle(pageNum) {
    ...
    const base = 'Icterícia neonatal — Neonatologia (Parte 2, M8)';
  ...
  function onHashChange() {
    ...
    showPage(page);
    // Notifica subscribers (caso-eusebio.js, bauer-revisable, etc.)
    document.dispatchEvent(new CustomEvent('m8:pagechange', { detail: { page } }));
  }
